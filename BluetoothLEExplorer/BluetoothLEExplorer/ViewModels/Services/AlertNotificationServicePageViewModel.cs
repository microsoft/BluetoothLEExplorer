// <copyright file="AlertNotificationServicePageViewModel.cs" company="Microsoft Corporation">
...
namespace BluetoothLEExplorer.ViewModels
{
    ...
    /// </summary>
    public class AlertNotificationServicePageViewModel : ViewModelBase
    {
        /// <summary>
        /// App context
        /// </summary>
        ...
        /// </summary>
        public AlertNotificationService Service { get; set; } = GattSampleContext.Context.SelectedGattServerService.Service as AlertNotificationService;

        /// <summary>
        /// Gets the New Alert characteristic.
        /// </summary>
        public GenericGattCharacteristicViewModel NewAlert { get; private set; }
        ...
        public GenericGattCharacteristicViewModel AlertNotificationControlPoint { get; private set; }
